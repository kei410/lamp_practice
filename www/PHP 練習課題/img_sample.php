...
// 画像ファイルのアップロード処理
$host     = 'localhost';
$username = 'codecamp42398';   // MySQLのユーザ名（マイページのアカウント情報を参照）
$password = 'codecamp42398';   // MySQLのパスワード（マイページのアカウント情報を参照）
$dbname   = 'codecamp42398';   // MySQLのDB名(このコースではMySQLのユーザ名と同じです）
...
try {
  ...
  // エラーがない場合のみ、アップロードした新しい画像ファイル名を保存
